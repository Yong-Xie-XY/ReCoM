...
class Generator(nn.Module):
    def __init__(self,
        ...
        if self.encoder_choice == 'meshtalk':
            ...
            self.audio_encoder = Wav2Vec2Model.from_pretrained("./wave2wec2-base960h")        # 不行就开这个
            # self.audio_encoder = Wav2Vec2Processor.from_pretrained("wav2wecProcess/wav2vec2-xls-r-300m-phoneme")
