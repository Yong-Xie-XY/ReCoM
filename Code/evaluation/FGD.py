...
class EmbeddingSpaceEvaluator:
    ...
    def push_samples(self, generated_poses, real_poses):
        ...
        generated_feat, generated_poses = self.ae.extract(generated_poses)          # extract pose feature by pretrained ae model
    ...
    def get_MAAC(self):
        ang_vel_list = []
        for real_joints in self.generated_joints_list:
