...
def parse_args():
    ...
    parser.add_argument('--talkshow_visual', action='store_true', help='Enable talkshow visual mode')
    parser.add_argument('--testmode', action='store_true', help='test mode')
    parser.add_argument('--body_model_path', default='./experiments/2024-12-20-11clock-smplx_S2G-EDIT/ckpt-99.pth', type=str)
